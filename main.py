...
def helper(dis):
    ...
    pre_list = pre.values.tolist() if not pre.empty else []
...
def get_predicted_value(patient_symptoms):
    ...
    disease_name = diseases_list.get(pred_index, "Unknown")
    return disease_name
...
def predict():
    ...
    response["precautions"] = pre
    response["medications"] = med
    response["diets"] = die
    response["workouts"] = wrk
